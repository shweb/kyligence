...
return deferred}}})(jQuery,window);window.wp=window.wp||{};(function(wp,$){'use strict';var $containerPolite,$containerAssertive;function speak(message,ariaLive){clear();message=$('<p>').html(message).text();if($containerAssertive&&'assertive'===ariaLive){$containerAssertive.text(message)}else if($containerPolite){$containerPolite.text(message)}}
