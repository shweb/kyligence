				...
				<ul class="thumbnails image_picker_selector">
					...
					if (!empty($settings['value'])) {
						foreach ($settings['value'] as $index => $data) {
							...
							?>
							<li>
								<div class="dfd_form_preset_select thumbnail <?php echo $selected?>">
									...
									<img class="image_picker_image" src="<?php echo esc_url($img); ?>">
					...
					var Dfd_form_preset_select = {
						init: function(){
							$(".dfd_form_preset_select").click(function(){
								$(".dfd_form_preset_select").removeClass("selected");
