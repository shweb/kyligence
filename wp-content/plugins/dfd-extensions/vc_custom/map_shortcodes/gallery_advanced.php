...
*/
class WPBakeryShortCode_Dfd_Gallery_Advanced_Module extends WPBakeryShortCode {}

vc_map(
	array(
		'name'			=> esc_attr__('Gallery Advanced','dfd-native'),
		'base'			=> 'dfd_gallery_advanced_module',
		'class'			=> 'dfd_gallery_advanced dfd_shortcode',
		'icon'			=> 'dfd_gallery_advanced dfd_shortcode',
		...
		'params'		=> array(
			...
			array(
				'type'			=> 'number',
				'heading'		=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to set the height for the gallery','dfd-native').'</span></span>'.esc_html__('Module height', 'dfd-native'),
			...
			array(
				...
				'heading'		=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Values from 2 to 6 are acceptable','dfd-native').'</span></span>'.esc_html__('Galleries to show', 'dfd-native'),
			...
			array(
				...
				'doc_link'			=> '//nativewptheme.net/support/visual-composer/gallery-advanced',
				'video_link'		=> 'https://www.youtube.com/watch?v=Vk94hrDKBDQ&feature=youtu.be',
			),
			array(
				'type'             => 'dfd_heading_param',
