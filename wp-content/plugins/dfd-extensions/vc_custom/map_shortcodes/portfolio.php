	...
	array(
		...
		'params' => array(
			...
			array(
				...
				'dependency' => array('element' => 'portfolio_style','value' => array('carousel','carousel_skew','carousel_centered','carousel_skewed_centered','fitRows','masonry')),
				'group'      => esc_attr__( 'Content', 'dfd-native' ),
			),
			array(
				'type'             => 'dfd_heading_param',
			...
			array(
				...
				'dependency' => array('element' => 'portfolio_style','value' => array('carousel', 'carousel_centered')),
				'group'      => esc_attr__( 'Content', 'dfd-native' ),
			),
			array(
				'type' => 'number',
