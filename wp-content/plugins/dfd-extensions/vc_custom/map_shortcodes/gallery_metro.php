...
*/
class WPBakeryShortCode_Dfd_Gallery_Metro_Module extends WPBakeryShortCode {}

vc_map(
	array(
		'name' => esc_attr__('Gallery Metro','dfd-native'),
		'base' => 'dfd_gallery_metro_module',
		'class' => 'dfd_gallery_metro dfd_shortcode',
		'icon' => 'dfd_gallery_metro dfd_shortcode',
		'category' => esc_attr__('Native','dfd-native'),
		'description' => esc_attr__('Displays metro gallery','dfd-native'),
		...
		'params' => array(
			...
			array(
				...
				'value'	=> 'loop',
				'options' => array(
					esc_attr__('Loop','dfd-native') => 'loop',
					esc_attr__('Single item','dfd-native') => 'single',
				),
			),
			array(
				'type'				=> 'param_group',
				...
				'params'			=> array(
					...
					array(
						...
						'heading'     => '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Select the size for the item','dfd-native').'</span></span>'.esc_html__( 'Item size', 'dfd-native' ),
			...
			array(
				...
				'doc_link'			=> '//nativewptheme.net/support/visual-composer/gallery-metro',
				'video_link'		=> 'https://www.youtube.com/watch?v=AGjTdh_r-H4&feature=youtu.be',
			),
			array(
				'type'             => 'dfd_heading_param',
