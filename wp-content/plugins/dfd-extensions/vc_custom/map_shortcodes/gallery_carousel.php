...
*/
class WPBakeryShortCode_Dfd_Gallery_Carousel_Module extends WPBakeryShortCode {}

vc_map(
	array(
		'name' => esc_attr__('Gallery Tilted Carousel','dfd-native'),
		'base' => 'dfd_gallery_carousel_module',
		'class' => 'dfd_gallery_carousel dfd_shortcode',
		'icon' => 'dfd_gallery_carousel dfd_shortcode',
		'category' => esc_attr__('Native','dfd-native'),
		'description' => esc_attr__('Displays Gallery items as tilted carousel','dfd-native'),
		...
		'params' => array(
			...
			array(
				...
				'heading' => '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to set the height for the carousel','dfd-native').'</span></span>'.esc_html__('Carousel height', 'dfd-native'),
				'param_name' => 'gallery_image_ratio',
				'value'	=> '2.5',
				'options' => array(
			...
			array(
				'type' => 'number',
				'heading' => '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to set the border radius for the gallery\'s thumbnail','dfd-native').'</span></span>'.esc_html__('Thumb border radius', 'dfd-native'),
				'param_name' => 'gallery_rounded',
				'value' => 6,
			...
			array(
				...
				'doc_link'			=> '//nativewptheme.net/support/visual-composer/gallery-tilted-carousel',
				'video_link'		=> 'https://www.youtube.com/watch?v=JcdqRIREFDo&feature=youtu.be',
			),
			array(
				'type'             => 'dfd_heading_param',
			...
			array (
				'type' => 'dfd_single_checkbox',
				'param_name' => 'use_dots',
				'heading' => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to add the pagination dots for your gallery carousel','dfd-native').'</span></span>'.esc_html__('Pagination', 'dfd-native'),
				'value' => 'show',
				'options' => array (
					'show' => array (
