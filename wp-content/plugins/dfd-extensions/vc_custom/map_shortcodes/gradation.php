...
class WPBakeryShortCode_Dfd_Gradation extends WPBakeryShortCode {}
...
$module_images = DFD_EXTENSIONS_PLUGIN_URL .'vc_custom/admin/img/gradation/';
vc_map(
	array(
		'name'					=> esc_html__('Gradation', 'dfd-native'),
		'base'					=> 'dfd_gradation',
		'class'					=> 'dfd_gradation dfd_shortcode',
		'icon'					=> 'dfd_gradation dfd_shortcode',
		'category'				=> esc_html__('Native', 'dfd-native'),
		'description'			=> esc_html__('Allows you to display info blocks in one chain.', 'dfd-native'),
		'params'				=> array(
			array(
			...
			array(
				'type'				=> 'dfd_radio_advanced',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Please, select width of the element according to the width of the container','dfd-native').'</span></span>'.esc_html__('Element width', 'dfd-native'),
			...
			array(
				...
				'doc_link'			=> '//nativewptheme.net/support/visual-composer/gradation',
				'video_link'		=> 'https://www.youtube.com/watch?v=XvRzgw2pGa0&feature=youtu.be',
			),
			array(
				'type'				=> 'param_group',
			...
			array(
				'type'				=> 'colorpicker',
				'heading'			=> '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose the color for the icon. The default icon color is #e7e7e7','dfd-native').'</span></span>'.esc_html__('Icon color', 'dfd-native'),
			...
			array(
				'type'				=> 'colorpicker',
				'heading'			=> '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose the hover color for the icon. The default icon hover color is #fff','dfd-native').'</span></span>'.esc_html__('Icon hover color', 'dfd-native'),
			...
			array(
				'type'				=> 'colorpicker',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose the border color for the gradation element. The default value is inherited from Theme Options > Styling Options > Main site color','dfd-native').'</span></span>'.esc_html__('Border color', 'dfd-native'),
			...
			array(
				'type'				=> 'colorpicker',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose the border hover color for the gradation element. The default value is inherited from Theme Options > Styling Options > Main site color','dfd-native').'</span></span>'.esc_html__('Border hover color', 'dfd-native'),
			...
			array(
				'type'				=> 'colorpicker',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose the icon background color. The default color is transparent','dfd-native').'</span></span>'.esc_html__('Icon background color', 'dfd-native'),
			...
			array(
				'type'				=> 'colorpicker',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose the icon hover background color. The default value is inherited from Theme Options > Styling Options > Main site color','dfd-native').'</span></span>'.esc_html__('Icon hover background color', 'dfd-native'),
			...
			array(
				'type'				=> 'number',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to add the space between the gradation elements','dfd-native').'</span></span>'.esc_html__('Space between blocks', 'dfd-native'),
