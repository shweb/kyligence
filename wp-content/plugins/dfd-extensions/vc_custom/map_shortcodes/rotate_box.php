...
vc_map(
	array(
		...
		'params'				=> array(
			...
			array(
				'type'				=> 'dfd_radio_advanced',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('','dfd-native').'</span></span>'.esc_html__('Horizontal Alignment', 'dfd-native'),
			...
			array(
				'type'				=> 'dfd_radio_advanced',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('','dfd-native').'</span></span>'.esc_html__('Vertical alignment', 'dfd-native'),
