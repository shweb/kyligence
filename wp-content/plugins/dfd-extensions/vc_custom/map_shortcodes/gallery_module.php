...
class WPBakeryShortCode_Dfd_Gallery_Module_Shortcode extends WPBakeryShortCode {}

vc_map(
	array(
		'name' => esc_attr__('Gallery module','dfd-native'),
		'base' => 'dfd_gallery_module_shortcode',
		'class' => 'dfd_gallery dfd_shortcode',
		'icon' => 'dfd_gallery dfd_shortcode',
		...
		'description' => esc_attr__('Displays Gallery items','dfd-native'),
		'params' => array(
			array(
			...
			array(
				...
				'doc_link'			=> '//nativewptheme.net/support/visual-composer/gallery-module',
				'video_link'		=> 'https://www.youtube.com/watch?v=Xix8pKL1Tuw&feature=youtu.be',
			),
			array(
				'type'				=> 'dfd_heading_param',
				'text'				=> esc_html__( 'Gallery items settings', 'dfd-native' ),
			...
			array(
				'type' => 'number',
				'heading' => '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Set the number of items you would like to display','dfd-native').'</span></span>'.esc_html__('Galleries to show', 'dfd-native'),
			...
			array(
				'type' => 'number',
				'heading' => '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to add the space between the gallery items','dfd-native').'</span></span>'.esc_html__('Items offset', 'dfd-native'),
				'param_name' => 'items_offset',
				'value' => 20,
				'edit_field_class' => 'vc_column vc_col-sm-6 no-border-bottom crum_vc dfd-number-wrap',
				'dependency' => array('element' => 'gallery_style','value' => array('carousel','carousel_skew','carousel_centered','carousel_skewed_centered','fitRows','masonry')),
				'group'      => esc_attr__( 'Content', 'dfd-native' ),
			),
			array(
				'type'             => 'dfd_heading_param',
			...
			array(
				...
				'heading' => '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to set the number of columns for the gallery items','dfd-native').'</span></span>'.esc_html__('Number of columns', 'dfd-native'),
				'param_name' => 'columns',
				'value' => 3,
				'options' => array(
				...
				'dependency' => array('element' => 'gallery_style','value_not_equal_to' => array('justified')),
				'group'      => esc_attr__( 'Content', 'dfd-native' ),
			),
			array(
				...
				'dependency' => array('element' => 'gallery_style','value' => array('carousel', 'carousel_centered')),
				'group'      => esc_attr__( 'Content', 'dfd-native' ),
			),
			array(
				'type' => 'number',
			...
			array(
				...
				'dependency' => array('element' => 'gallery_style','value' => array('masonry','fitRows')),
				'group'      => esc_attr__( 'Content', 'dfd-native' ),
			),
			array(
				'type' => 'dfd_single_checkbox',
				'heading' => esc_html__('Category','dfd-native'),
				'param_name' => 'gallery_show_top_cat',
				'value' => '',
				'options' => array(
					'on' => array(
							'label' => '',
			...
			array(
				...
				'param_name' => 'gallery_show_subtitle',
				'options' => array(
					'on' => array(
							'label' => '',
							'on' => 'Yes',
			...
			array(
				'type' => 'dfd_single_checkbox',
				'heading' => esc_html__('Date in gallery meta','dfd-native'),
				'param_name' => 'gallery_show_meta_date',
				'value' => 'on',
				'options' => array(
					'on' => array(
							'label' => '',
				...
				'edit_field_class' => 'vc_column vc_col-sm-6 crum_vc',
				'dependency' => array('element' => 'gallery_show_meta','value' => array('on')),
				'group'      => esc_attr__( 'Content', 'dfd-native' ),
			),
			array(
				'type' => 'dfd_single_checkbox',
				'heading' => esc_html__('Category in gallery meta','dfd-native'),
				'param_name' => 'gallery_show_meta_category',
				'value' => 'on',
				'options' => array(
					'on' => array(
							'label' => '',
			...
			array(
				'type' => 'dfd_single_checkbox',
				'heading' => esc_html__('Comments counter in gallery meta','dfd-native'),
				'param_name' => 'gallery_show_meta_comments',
				'value' => 'on',
				'options' => array(
					'on' => array(
							'label' => '',
			...
			array(
				'type' => 'dfd_single_checkbox',
				'heading' => esc_html__('Likes in gallery meta','dfd-native'),
				'param_name' => 'gallery_show_meta_likes',
				'value' => 'on',
				'options' => array(
					'on' => array(
							'label' => '',
			...
			array(
				'type'				=> 'dfd_radio_advanced',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to choose the displaying of the gallery info content. You can set the content under or infront of the gallery items','dfd-native').'</span></span>'.esc_html__('Content position','dfd-native'),
				'param_name'		=> 'gallery_content_position',
				'value'				=> 'bottom',
				'options'			=> array(
					esc_html__('Bottom','dfd-native')	=> 'bottom',
					esc_html__('Front','dfd-native')	=> 'front',
				),
				'edit_field_class'	=> 'vc_column vc_col-sm-6 crum_vc',
				'dependency'		=> array('element' => 'gallery_style','value' => array('carousel','carousel_skew','carousel_centered','carousel_skewed_centered','fitRows','masonry')),
				'group'				=> esc_html__( 'Content', 'dfd-native' ),
			...
			array(
				'type'				=> 'dfd_radio_advanced',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to choose the vertical alignment for the gallery info','dfd-native').'</span></span>'.esc_html__('Content vertical alignment','dfd-native'),
				'param_name'		=> 'gallery_content_valign',
				'value'				=> 'bottom',
				'options'			=> array(
					esc_html__('Bottom','dfd-native')	=> 'bottom',
					esc_html__('Middle','dfd-native')	=> 'middle',
					esc_html__('Top','dfd-native')		=> 'top',
				),
				'edit_field_class'	=> 'vc_column vc_col-sm-6 crum_vc',
				'dependency'		=> array('element' => 'gallery_content_position','value' => array('front')),
				'group'				=> esc_html__( 'Content', 'dfd-native' ),
			),
			array(
				'type'				=> 'dfd_radio_advanced',
				'heading'			=> '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to choose the horizontal alignment for the gallery info','dfd-native').'</span></span>'.esc_html__('Content alignment','dfd-native'),
				'param_name'		=> 'gallery_content_alignment',
				'value'				=> 'text-left',
				'options'			=> array(
					esc_html__('Left','dfd-native')	=> 'text-left',
					esc_html__('Center','dfd-native')	=> 'text-center',
			...
			array(
				...
				'param_name'  => 'gallery_hover_enable',
				'value' => 'on',
				'options' => array(
					'on' => array(
						'label' => '',
			...
			array(
				...
				'param_name'		=> 'gallery_content_style',
				'value'				=> 'standard',
				'options'			=> array(
				...
				'edit_field_class'	=> 'vc_column vc_col-sm-6 crum_vc',
				'dependency'		=> array('element' => 'gallery_hover_enable','value' => array('on')),
				'group'				=> esc_attr__( 'Hover', 'dfd-native' ),
			),
			array(
				'type' => 'dropdown',
				...
				'param_name' => 'gallery_hover_appear_effect',
				'value' => array(
			...
			array(
				...
				'param_name' => 'gallery_hover_image_effect',
				...
				'dependency' => array(
					'element' => 'gallery_hover_appear_effect',
					'value' => array(
			...
			array(
				...
				'param_name' => 'gallery_hover_mask_color',
				'edit_field_class' => 'vc_column vc_col-sm-6',
				'dependency' => array('element' => 'gallery_hover_enable','value' => array('on')),
				'group' => esc_attr__( 'Hover', 'dfd-native' ),
			),
			array(
				...
				'param_name'		=> 'gallery_hover_mask_background_style',
				'value'				=> 'simple-color',
				'options'			=> array(
			...
			array (
				...
				'param_name' => 'gallery_hover_mask_background',
				'edit_field_class' => 'vc_column vc_col-sm-12 dfd-hide-alpha',
				'dependency' => array('element' => 'gallery_hover_mask_background_style','value' => array('simple-color')),
				'group' => esc_attr__( 'Hover', 'dfd-native' ),
			),
			array (
				'type' => 'colorpicker',
				'param_name' => 'gallery_hover_mask_bg_start_color',
				...
				'dependency' => array('element' => 'gallery_hover_mask_background_style','value' => array('gradient')),
				'group' => esc_attr__( 'Hover', 'dfd-native' ),
			),
			array (
				'type' => 'colorpicker',
				'param_name' => 'gallery_hover_mask_bg_end_color',
			...
			array(
				...
				'min' => 1,
				'max' => 100,
				'param_name' => 'gallery_hover_mask_background_opacity',
				'dependency' => array('element' => 'gallery_hover_enable','value' => array('on')),
			...
			array(
				...
				'param_name' => 'gallery_hover_mask_border',
				'options' => array(
					'on' => array(
						'label' => '',
						'on' => 'Yes',
			...
			array(
				...
				'param_name'		=> 'gallery_hover_mask_bordered_style',
				'value'				=> 'simple-border',
				'options'			=> array(
				...
				'edit_field_class'	=> 'vc_column vc_col-sm-6 no-border-bottom',
				'dependency'		=> array('element' => 'gallery_hover_mask_border','value' => array('on')),
				'group'				=> esc_attr__( 'Hover', 'dfd-native' ),
			),
			array(
				'type' => 'number',
				...
				'param_name' => 'gallery_hover_mask_bordered_size',
				'edit_field_class'	=> 'vc_column vc_col-sm-6 no-border-bottom crum_vc dfd-number-wrap',
				'dependency' => array('element' => 'gallery_hover_mask_border','value' => array('on')),
				'group'      => esc_attr__( 'Hover', 'dfd-native' ),
			),
			...
			array(
				...
				'param_name'		=> 'gallery_hover_main_decoration_link',
				'value'				=> 'lightbox',
				'options'			=> array(
				...
				'dependency'		=> array('element' => 'gallery_hover_main_decoration','value_not_equal_to' => array('buttons')),
				'group'				=> esc_html__( 'Hover', 'dfd-native' ),
			),
			array(
				'type'				=> 'dfd_radio_advanced',
				...
				'param_name'		=> 'gallery_hover_main_decoration',
				'value'				=> 'heading',
				'options'			=> array(
					esc_html__('Heading','dfd-native') => 'heading',
					esc_html__('Plus','dfd-native')	=> 'plus',
					esc_html__('Dots','dfd-native')	=> 'dots',
					esc_html__('Buttons','dfd-native') => 'buttons',
			...
			array(
				'type' => 'dfd_single_checkbox',
				'heading' => esc_html__('Title','dfd-native'),
				'param_name' => 'gallery_hover_show_title',
				'value' => 'on',
				'options' => array(
					'on' => array(
						'label' => '',
				...
				'edit_field_class'	=> 'vc_column vc_col-sm-6 no-border-bottom',
				'dependency' => array('element' => 'gallery_hover_main_decoration','value' => array('heading')),
				'group'      => esc_attr__( 'Hover', 'dfd-native' ),
			),
			array(
				'type' => 'dfd_single_checkbox',
				'heading' => esc_html__('Subtitle','dfd-native'),
				'param_name' => 'gallery_hover_show_subtitle',
				'value' => 'on',
				'options' => array(
					'on' => array(
						'label' => '',
			...
			array(
				...
				'param_name' => 'gallery_hover_plus_position',
				'value' => array(
				...
				'dependency' => array('element' => 'gallery_hover_main_decoration','value' => array('plus')),
				'group'      => esc_attr__( 'Hover', 'dfd-native' ),
			),
			array(
				'type' => 'dfd_single_checkbox',
				'heading' => esc_html__('Link inside gallery item','dfd-native'),
				'param_name' => 'gallery_hover_buttons_inside',
				'value' => 'on',
				'options' => array(
					'on' => array(
						'label' => '',
				...
				'edit_field_class'	=> 'vc_column vc_col-sm-6',
				'dependency' => array('element' => 'gallery_hover_main_decoration','value' => array('buttons')),
				'group'      => esc_attr__( 'Hover', 'dfd-native' ),
			),
			array(
				'type' => 'dfd_single_checkbox',
				'heading' => esc_html__('Gallery item external link','dfd-native'),
				'param_name' => 'gallery_hover_buttons_external',
				'value' => 'on',
				'options' => array(
					'on' => array(
						'label' => '',
			...
			array(
				...
				'param_name' => 'gallery_hover_buttons_lightbox',
				'value' => 'on',
				'options' => array(
					'on' => array(
						'label' => '',
			...
			array (
				'type' => 'colorpicker',
				'heading' => '<span class="dfd-vc-toolip"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('Choose the buttons background color. The default value is inherited from Theme Options > Gallery Options > Gallery hover style options > Buttons background','dfd-native').'</span></span>'. esc_html__('Buttons background', 'dfd-native'),
				'param_name' => 'gallery_hover_buttons_bg',
				'group' => esc_attr__( 'Hover', 'dfd-native' ),
				'edit_field_class' => 'vc_column vc_col-sm-6 no-border-bottom',
				'dependency' => array('element' => 'gallery_hover_main_decoration','value' => array('buttons')),
			),
			array (
				'type' => 'dfd_single_checkbox',
				'param_name' => 'use_dots',
				'heading' => '<span class="dfd-vc-toolip tooltip-bottom"><i class="dfd-socicon-question-sign"></i><span class="dfd-vc-tooltip-text">'.esc_html__('This option allows you to add the pagination dots for you gallery carousel','dfd-native').'</span></span>'.esc_html__('Pagination','dfd-native'),
				'value' => 'show',
				'options' => array (
					'show' => array (
