...
get_template_part('inc/loop/posts/gallery_shortcode_advanced');

$options = array(
	'gallery_style' => 'carousel_centered',
	'posts_to_show' => 3,
	'module_height' => 400,
...
$post = new Dfd_gallery_shortcode_advanced($gallery_atts);
...
$el_class .= ' dfd-gallery-advanced layout-'.$gallery_style.' dfd-columns-'.$posts_to_show;
...
$css_rules .= '#'.esc_js($uniqid).' > .dfd-gallery-module.dfd-gallery-advanced > .dfd-gallery-module-inner {height: '. esc_js((int)$module_height) .'px;}';
...
echo '<div id="'.esc_attr($uniqid).'" class="dfd-gallery-advanced-module-wrap">';
	echo '<div class="dfd-gallery-module '.esc_attr($el_class).'" '.$data_atts.'>';
		echo '<div class="dfd-gallery-module-inner">';
