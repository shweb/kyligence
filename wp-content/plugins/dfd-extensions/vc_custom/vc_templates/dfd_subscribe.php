...
$output .= '<div id="'.esc_js($unique_id).'" class="dfd-subscribe-wrap '. esc_attr($el_class).'" '.$animation_data.'>';
	...
	$output .= '<div class="form-container">';
		$output .= '<form action="http://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open(\'http://feedburner.google.com/fb/a/mailverify?uri='. $subscribe_module_feed_name.'\', \'popupwindow\', \'scrollbars=yes,width=550,height=520\');return true">';
			$output .= '<table>';
				$output .= '<tr>';
