    ...
    class ReduxFramework_select {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : esc_html__( 'Select an item', 'dfd-native' );
                ...
                echo '<strong>' . esc_html__( 'No items of this type were found.', 'dfd-native' ) . '</strong>';
            }
        } //function
