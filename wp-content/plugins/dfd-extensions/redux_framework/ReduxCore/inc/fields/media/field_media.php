...
if ( ! class_exists( 'ReduxFramework_media' ) ) {
    ...
    class ReduxFramework_media {
        ...
        public function render() {
            ...
            //echo '<span class="button media_upload_button" id="' . $this->field['id'] . '-media">' . esc_html__( 'Upload', 'dfd-native' ) . '</span>';
				echo '<div class="buttons-cover">';
					echo '<span class="media_upload_button" id="' . $this->field['id'] . '-media"><span class="' . $hide . ' screenshot"><img class="redux-option-image" id="image_' . $this->field['id'] . '" src="' . $this->value['thumbnail'] . '" alt="" target="_blank" rel="external" /></span><span class="no-image-holder '.$placeholder_hide.'"><i class="crdash-plus"></i>'.__('Upload image','dfd-native').'</span></span>';

					//echo '<span class="button remove-image' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . esc_html__( 'Remove', 'dfd-native' ) . '</span>';
					echo '<span class="dashicons dashicons-no remove-image ' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '"></span>';
				echo '</div>';
