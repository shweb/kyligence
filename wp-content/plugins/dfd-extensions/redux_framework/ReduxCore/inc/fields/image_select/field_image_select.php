        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                foreach ( $this->field['options'] as $k => $v ) {
                    ...
                    $theValue = $k;
                    if ( ! empty( $this->field['tiles'] ) && $this->field['tiles'] == true && (!isset($this->field['dfd_tiles']) || $this->field['dfd_tiles'] !== true)) {
                        $theValue = $v['img'];
                    }
					...
					if ( ! empty( $this->field['tiles'] ) && $this->field['tiles'] == true ) {
						$class = 'dfd-tiles';
						$span_class = 'tooltip';
						if((!isset($this->field['dfd_tiles']) || $this->field['dfd_tiles'] !== true)) {
							$class = 'tiles';
							$span_class = '';
						}
                        echo '<span class="'.esc_attr($class).'" style="background-image: url(' . $v['img'] . ');" rel="' . $v['img'] . '"">&nbsp;</span>';
                    } else {
                        echo '<img src="' . $v['img'] . '" alt="' . $v['alt'] . '" style="' . $style . '"' . $presets . $merge . ' />';
                    }

                    if ( $v['title'] != '' ) {
                        echo '<span class="'.esc_attr($span_class).'">' . $v['title'] . '</span>';
                    }
