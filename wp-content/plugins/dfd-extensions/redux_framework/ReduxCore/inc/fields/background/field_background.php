            ...
            public function render() {
                ...
                if ( $this->field['background-color'] === true ) {
                    ...
                    if ( ! isset( $this->field['transparent'] ) || $this->field['transparent'] !== false ) {
                        ...
                        echo '<label for="' . $this->field['id'] . '-transparency" class="color-transparency-check"><input type="checkbox" class="checkbox color-transparency redux-background-input ' . $this->field['class'] . '" id="' . $this->field['id'] . '-transparency" data-id="' . $this->field['id'] . '-color" value="1"' . $tChecked . '> ' . esc_html__( 'Transparent', 'dfd-native' ) . '</label>';
                    }
				...
				echo '<div class="dropdowns-wrap clearfix">';
					if ( $this->field['background-repeat'] === true ) {
						...
						echo '<div class="select-cover">';
							echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . esc_html__( 'Background Repeat', 'dfd-native' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-repeat]" class="redux-select-item redux-background-input redux-background-repeat ' . $this->field['class'] . '">';
							echo '<option></option>';
					...
					if ( $this->field['background-clip'] === true ) {
						...
						echo '<div class="select-cover">';
							echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . esc_html__( 'Background Clip', 'dfd-native' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-clip]" class="redux-select-item redux-background-input redux-background-clip ' . $this->field['class'] . '">';
							echo '<option></option>';
					...
					if ( $this->field['background-origin'] === true ) {
						...
						echo '<div class="select-cover">';
							echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . esc_html__( 'Background Origin', 'dfd-native' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-origin]" class="redux-select-item redux-background-input redux-background-origin ' . $this->field['class'] . '">';
							echo '<option></option>';
					...
					if ( $this->field['background-size'] === true ) {
						...
						echo '<div class="select-cover">';
							echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . esc_html__( 'Background Size', 'dfd-native' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-size]" class="redux-select-item redux-background-input redux-background-size ' . $this->field['class'] . '">';
							echo '<option></option>';
					...
					if ( $this->field['background-attachment'] === true ) {
						...
						echo '<div class="select-cover">';
							echo '<select id="' . $this->field['id'] . '-attachment-select" data-placeholder="' . esc_html__( 'Background Attachment', 'dfd-native' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-attachment]" class="redux-select-item redux-background-input redux-background-attachment ' . $this->field['class'] . '">';
							echo '<option></option>';
							foreach ( $array as $k => $v ) {
					...
					if ( $this->field['background-position'] === true ) {
						...
						echo '<div class="select-cover">';
							echo '<select id="' . $this->field['id'] . '-position-select" data-placeholder="' . esc_html__( 'Background Position', 'dfd-native' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-position]" class="redux-select-item redux-background-input redux-background-position ' . $this->field['class'] . '">';
							echo '<option></option>';
                ...
                if ( $this->field['background-image'] === true ) {
                    ...
                    $placeholder = isset( $this->field['placeholder'] ) ? $this->field['placeholder'] : esc_html__( 'No media selected', 'dfd-native' );
                    ...
                    echo '<span class="button redux-background-upload" id="' . $this->field['id'] . '-media"><i class="crdash-plus"></i>' . esc_html__( 'Upload', 'dfd-native' ) . '</span>';
                    ...
                    echo '<span class="button removeCSS redux-remove-background' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . esc_html__( 'Remove', 'dfd-native' ) . '</span>';
