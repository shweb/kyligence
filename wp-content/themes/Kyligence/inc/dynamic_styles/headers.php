...
/*Sticky header*/
$output .= '#header-container.small #header .dfd-top-row,'
		. '#header-container.small #header .header-wrap {'
			. 'background: '.$vars['fixed_header_background_color'].';'
		. '}';

$output .= '#header-container.small #header .dfd-top-row > .row > .columns,'
...
$output .= '#header-container.small #header .header-wrap .dfd-click-menu-activation-button a .icon-wrap,'
...
$output .= '#header-container.small #header .header-wrap .dfd-header-buttons-wrap > *,'
		. '#header-container.small.logo-position-right #header .header-wrap .dfd-header-buttons-wrap > *:first-child,'
