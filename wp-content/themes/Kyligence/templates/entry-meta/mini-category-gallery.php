...
<?php if (isset($product_terms[0]) && !empty($product_terms[0]) && !is_wp_error($product_terms)):
	...
	<span class="byline category">
		<a href="<?php echo esc_url(get_term_link($product_terms[0]->slug, 'gallery_category')); ?>" class="fn" <?php echo (isset($cat_meta['custom_term_meta_color']) && !empty($cat_meta['custom_term_meta_color'])) ? 'style="background: '.esc_attr($cat_meta['custom_term_meta_color']).'"' : ''; ?>>
